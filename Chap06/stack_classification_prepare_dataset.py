...
def get_parser():
    ...
    parser.add_argument('--posts-file', default='data/Posts.jsonl')
    parser.add_argument('--tags-file', default='data/Tags.jsonl')
    parser.add_argument('--output', default='data/movies.question4classification.jsonl')
    parser.add_argument('--min-df', type=int, default=200)
    return parser
