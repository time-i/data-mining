...
def get_parser():
    ...
    parser.add_argument('--questions', default='data/movies.question4classification.jsonl')
    parser.add_argument('--output', default='data/questions-svm-classifier.pickle')
